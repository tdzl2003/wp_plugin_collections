...
add_option('wechat-app-login', array(
		"appid" => "",
		"appkey" => "",
	));

class WP_WECHAT_APP_LOGIN_Options {
	...
	public function render_page() {
	    ...
	    $opt_val = get_option('wechat-app-login');
	    ...
	    if (isset($_POST['appid']) && isset($_POST['appkey'])){
	    	if (!wp_verify_nonce($_POST['nonce'], 'set_option')){
		    	...
		    	update_option('wechat-app-login', $opt_val);
